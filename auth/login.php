...
<head>
  ...
  <meta name="description" content="تسجيل الدخول إلى حسابك في علامة ALAMAH.">
  <title>تسجيل الدخول | علامة ALAMAH</title>
  ...
  <link rel="canonical" href="<?= SITE_URL ?>/auth/login.php">
  <meta property="og:title" content="تسجيل الدخول | علامة ALAMAH">
  <meta property="og:description" content="تسجيل الدخول إلى حسابك في علامة ALAMAH.">
  <meta property="og:image" content="<?= SITE_URL ?>/image/logo.png">
  <meta property="og:url" content="<?= SITE_URL ?>/auth/login.php">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="علامة | ALAMAH">
  <meta property="og:locale" content="ar_SA">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="تسجيل الدخول | علامة ALAMAH">
  <meta name="twitter:description" content="تسجيل الدخول إلى حسابك في علامة ALAMAH.">
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .btn-auth{width:100%;padding:0.9rem;background:linear-gradient(135deg,#1B2A5B,#2A3F7E);color:#fff;border:none;border-radius:12px;font-family:'Tajawal',sans-serif;font-weight:700;font-size:1rem;cursor:pointer;transition:all 0.3s;margin-top:0.5rem}
...
<body>
  <div class="auth-card">
    ...
    <p class="auth-subtitle">مرحباً بعودتك! سجّل دخولك للمتابعة</p>
    ...
    <p class="auth-link"><a href="forgot_password.php">نسيت كلمة المرور؟</a></p>
